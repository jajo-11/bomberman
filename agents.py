...
AGENT_API = {
  ...
  "train": {
    ...
    "game_events_occurred": ["self", "old_game_state: dict", "self_action: str", "new_game_state: dict",
                             "events: List[str]"],
    "enemy_game_events_occurred": ["self", "enemy_name: str", "old_enemy_game_state: dict", "enemy_action: str",
...
class Agent:
  ...
  def process_enemy_game_events(self, enemy_game_state, enemy: "Agent"):
    self.backend.send_event("enemy_game_events_occurred", enemy.name, enemy.last_game_state, enemy.last_action,
                            enemy_game_state, enemy.events)
